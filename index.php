    ...
    ?>
      <div class="col-3">
        <div class="card text-center">
          ...
          <div class="card-body">
            <p class="card-text">
              <a href="product.php?product_id=<?php echo $product['product_id']; ?>" style="text-decoration: none; color:black; font-weight: bold;"><?php echo $product['product_name'] ?><br>MYR <?php echo $product['product_price'] ?></a>
            </p>
          </div>
        </div>
      </div>
